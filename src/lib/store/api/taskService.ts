...
export const taskApi = createApi({
  ...
  endpoints: (builder) => ({
    getAllTasks: builder.query<TasksResponse, string>({
      ...
      transformResponse: (response: { data: TasksResponse }) => response.data,
    }),
    ...
    getTask: builder.query<TaskResponse, SingleRequest>({
      ...
      transformResponse: (response: { data: TaskResponse }) => response.data,
    }),
    ...
    updateTask: builder.mutation<TaskResponse, TaskSingleRequest>({
